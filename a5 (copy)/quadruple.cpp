...
string Quadruple::write_node(){
	...
	else if(oprtion=="hdRow")
		return "Matrix q"+to_string(result)+"=q"+to_string(oprnd1)+".hdrow();\n";
	else if(oprtion=="hdCol")
		return "Matrix q"+to_string(result)+"=q"+to_string(oprnd1)+".hdcol();\n";
	else if(oprtion=="tlRows")
		return "Matrix q"+to_string(result)+"=q"+to_string(oprnd1)+".tlrows();\n";
	else if(oprtion=="tlCols")
		return "Matrix q"+to_string(result)+"=q"+to_string(oprnd1)+".tlcols();\n";
}
